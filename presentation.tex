...
\begin{frame}[fragile,t]{Further ressources}\vspace{10pt}
  Interactive git tutorial: %\href{dwd}{https://learngitbranching.js.org/?locale=en_US}
  Comprehensive git tutorial: %\href{dwd}{https://www.atlassian.com/git/tutorials/learn-git-with-bitbucket-cloud (requires an atlassian account(free))}
\end{frame}
