...
\begin{frame}[fragile,t]{Look back in time(git log)}\vspace{10pt}
  ...
  \begin{itemize}
    \item \textcolor{magenta}{--staged} also diff files which are already committed
    \item \textcolor{magenta}{HEAD} 
  \end{itemize}
...
\begin{frame}[fragile,t]{git reset}{10pt}
...
\begin{frame}[fragile,t]{git bisect}\vspace{10pt}
\end{frame}
